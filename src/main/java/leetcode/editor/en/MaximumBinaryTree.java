...
//leetcode submit region begin(Prohibit modification and deletion)
    ...
    class Solution {
        public TreeNode constructMaximumBinaryTree(int[] nums) {
            ...
            TreeNode maxTreeNode = new TreeNode(nums[maxIndex]);

            maxTreeNode.left = constructMaximumBinaryTree(Arrays.copyOfRange(nums, 0, maxIndex));
            maxTreeNode.right = constructMaximumBinaryTree(Arrays.copyOfRange(nums, maxIndex + 1, nums.length));
